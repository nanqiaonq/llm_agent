...
if __name__ == "__main__":
    print("="*80)
    print("Human-in-the-Loop (HITL) 中间件演示")
    print("="*80)
    print("\n本演示展示如何使用 HumanInTheLoopMiddleware 实现人工审批流程")
    print("\n支持的操作：")
    print("  - y: 批准并执行 (ApproveDecision)")
    print("  - e: 编辑参数后执行 (EditDecision)")
    print("  - n: 拒绝操作 (RejectDecision)")
    print("\n关键点：")
    print("  1. 使用 Command(resume=HITLResponse(...)) 来恢复执行")
    print("  2. HITLResponse 包含 decisions 列表")
    print("  3. 每个 decision 可以是 ApproveDecision、EditDecision 或 RejectDecision")
    print("="*80)
