    ...
    <EvidenceHighlightProvider>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <TeachingBanner
            title="这个系统如何增强信任？"
            description="每条提取的数据都与原文建立了视觉连接。当您查看任何数据时，系统会立即在原文中显示其来源位置，确保信息的准确性和可追溯性。这就像在纸质文档上用彩色荧光笔标记，但更加智能和互动。"
            tips={[
              '不同类型的数据使用不同颜色：蓝色=人物，紫色=组织，绿色=日期，琥珀色=金额',
              '悬停在数据卡片上时，原文中的对应文本会放大并闪烁提示',
              '每个数据卡片显示置信度评分，帮助您判断提取的准确性',
            ]}
            comparison="这替代了人工在文档中来回查找、用荧光笔标记并核对的过程，通常需要30-45分钟。"
          />
